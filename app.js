...
const DOM = {
    ...
    superposicionImagen: document.getElementById('superposicionImagen'),
    ...
    filteredProducts.forEach(product => {
        ...
        productCard.innerHTML = `
            <div class="contenedor-img">
                <img src="${product.img}" alt="${product.name}" class="img-producto" loading="lazy" onclick="expandImage('${product.img}')" style="cursor: zoom-in;" onerror="this.src='https://images.unsplash.com/photo-1512058564366-18510be2db19?w=600&h=400&fit=crop&q=80';">
...
function expandImage(src) {
    if (!src) return;
    DOM.imgLightbox.src = src;
    DOM.superposicionImagen.classList.add('visible');
    document.body.style.overflow = 'hidden';
}

function closeImageLightbox() {
    DOM.superposicionImagen.classList.remove('visible');
    document.body.style.overflow = '';
}
